"""
Django settings for newsocialist project.
...
ROOT_URLCONF = 'newsocialist.urls'
...
WSGI_APPLICATION = 'newsocialist.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "newsocialist", "static"),
]
